...
urlpatterns = [
	...
	url(r'^password_reset/$', views.PasswordResetView, name='password-reset'),
	url(r'^reset/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>[0-9A-Za-z]{1,13}-[0-9A-Za-z]{1,20})/$',views.PasswordResetConfirmView, name='password-reset-confirm'),
